...
const getSignedURLBodySchema = {
  ...
  properties: {
    ...
    // Pins the signed URL to this exact historical version - omit for the
    // existing "whatever is current at redemption time" behavior, matching
    // real S3's presigned URLs (versionId included in the signed request
    // pins it, omitted resolves against current at GET time).
