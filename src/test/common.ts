...
export function useMockObject() {
  beforeEach(() => {
    ...
    jest.clearAllMocks()
    jest.spyOn(S3Disk.prototype, 'getObject').mockResolvedValue({
      metadata: {
        httpStatusCode: 200,
        size: 3746,
        mimetype: 'image/png',
    ...
    jest.spyOn(S3Disk.prototype, 'uploadObject').mockResolvedValue({
      httpStatusCode: 200,
      size: 3746,
      mimetype: 'image/png',
      lastModified: new Date('Thu, 12 Aug 2021 16:00:00 GMT'),
    ...
    jest.spyOn(S3Disk.prototype, 'copyObject').mockResolvedValue({
      httpStatusCode: 200,
      lastModified: new Date('Thu, 12 Aug 2021 16:00:00 GMT'),
      eTag: 'abc',
    })

    jest.spyOn(S3Disk.prototype, 'deleteObject').mockResolvedValue()

    jest.spyOn(S3Disk.prototype, 'deleteObjects').mockResolvedValue()

    jest.spyOn(S3Disk.prototype, 'headObject').mockResolvedValue({
      httpStatusCode: 200,
      size: 3746,
      mimetype: 'image/png',
      eTag: 'abc',
